...
<div class="modal-header">
    <h4 class="modal-title" style="margin-top: 5px;color: #dd4b39" id="title">Proyectos</h4>
...
<div class="modal-footer justify-content-between">
    ...
    <button style="width: 20%; float: right" tabindex="5" id="guardar" class="btn btn-success" type="submit" form="form">Inscribirme</button>
</div>